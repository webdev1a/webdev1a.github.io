(() => {
    ...
    function getComments() {
        const commentsData = [ {
            ...
            img: "../img/slider/16.jpg"
        }, {
            img: "../img/slider/17.jpg"
        }, {
            img: "../img/slider/18.jpg"
        }, {
            img: "../img/slider/19.jpg"
        }, {
            img: "../img/slider/20.jpg"
        }, {
            img: "../img/slider/21.jpg"
        }, {
            img: "../img/slider/22.jpg"
        }, {
            img: "../img/slider/23.jpg"
        }, {
            img: "../img/slider/24.jpg"
        }, {
            img: "../img/slider/25.jpg"
        }, {
            img: "../img/slider/26.jpg"
        } ];
        renderComment(commentsData);
    }
    function renderComment(commentsData) {
        commentsData.forEach((function(item) {
            const comment = `\n        <div class="slider__item">\n\t\t<img data-lazy=${item.img} alt="slide">\n        </div>`;
